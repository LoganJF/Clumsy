...
ts = TimeSeriesLF.from_hdf('/Users/loganfickling/R1293P_fft_VI.h5')
...
R1293P_paths = glob(rhino_root + 'data/eeg/LFSleep/ProcData/*/*.h5')
paths = glob(rhino_root + 'data/eeg/LFSleep/ProcData/*/*/*.h5')
for p in paths:
    ts = TimeSeriesLF.from_hdf(p)
    break
    ts
    '~/Clumsy_0_0_3/test.5'
print(paths)
