...
class TimeSeriesLF(TimeSeries):
    ...
    def to_mne(timeseries, indicator=None, tmin=-1.):
        ...
        # Create MNE Dataset
        ch_names = list(timeseries['channels'].data)
        info = mne.create_info(ch_names, timeseries['samplerate'].data, ch_types='eeg')
